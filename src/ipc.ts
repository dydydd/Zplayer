...
export const ipc = {
  ...
  saveServer: (input: SaveServerInput) => invoke<SavedServer>("save_server", { input }),
  updateServerIcon: (input: ServerIconUpdate) => invoke<SavedServer>("update_server_icon", { input }),
