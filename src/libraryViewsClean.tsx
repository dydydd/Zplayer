    ...
    <div className="page library-page">
      ...
      <div className="library-heading">
        ...
        <div className="filters">
          ...
          <label>类型<select value={itemType} onChange={(event) => onOptionsChange(event.target.value as LibraryItemType, sortBy, sortOrder)}>
          ...
          <label>排序<select value={sortBy} onChange={(event) => onOptionsChange(itemType, event.target.value as LibrarySortBy, sortOrder)}>
          ...
          <label>方向<select value={sortOrder} onChange={(event) => onOptionsChange(itemType, sortBy, event.target.value as LibrarySortOrder)}>
